...
const server = new Server(
  {
    ...
    description: "Amazon Q MCP server installer and manager. Automatically installs MCP servers and configures Amazon Q default.json.",
    version: "1.0.0",
  },
  {
    capabilities: {
  ...
  tools: [
    {
      ...
      description: 'Install a new MCP server for Amazon Q from a GitHub repository URL or npm package. Automatically configures Amazon Q default.json.',
      inputSchema: {
        type: 'object',
        properties: {
          repo_url: {
